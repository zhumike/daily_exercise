...
inner_services = ['orders','demander','challenge','author','settlement','marketing','mcn','touch','generic','go_demander','go_author','task','go_orders']
outer_services = ['platform','goplatform','community']
...
skip_interfaces = {
    ...
    'challenge':['McnSearchAuthorsForContractChallenge','McnCanContractSpeciallyChallenge'],
    ...
    'goplatform':['GetRecommendSpuByVideoId','GetCouponConfigOptions','GetUserCouponInfo','GetStarIdByCommerceUserId','AwemeGetMineStarCardInfo'],
